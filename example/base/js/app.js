...
const configuration = {
  ...
  password   : account,
  // 授权码，请联系商务负责人获取
  secret_key : ''
};
...
document.querySelector('#call').onclick = function()
{
  ...
  const session = UA.call(`${linkman}@rtc.vsbc.com`, {
    mediaConstraints : {
      audio : true,
		  video:false,
    }
