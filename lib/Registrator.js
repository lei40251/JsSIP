...
${this._contact};${this._extraContactParams}`);
    ...
    const request_sender = new RequestSender(this._ua, request, {
      onRequestTimeout : () =>
      {
        this._registrationFailure(null, CRTC_C.causes.REQUEST_TIMEOUT);
      },
      onTransportError : () =>
      {
        this._registrationFailure(null, CRTC_C.causes.CONNECTION_ERROR);
      },
        ...
        switch (true)
        {
          ...
          case /^423$/.test(response.status_code):
          {
            ...
            { // This response MUST contain a Min-Expires header field.
              ...
              this._registrationFailure(response, CRTC_C.causes.SIP_FAILURE_CODE);
            }
  ...
  unregister(options = {})
  {
    ...
    {
      extraHeaders.push(`Contact: ${this._contact};${this._extraContactParams}`);
    }
    ...
    const request_sender = new RequestSender(this._ua, request, {
      onRequestTimeout : () =>
      {
        this._unregistered(null, CRTC_C.causes.REQUEST_TIMEOUT);
      },
      onTransportError : () =>
      {
        this._unregistered(null, CRTC_C.causes.CONNECTION_ERROR);
      },
      // Increase the CSeq on authentication.
      onAuthenticated : () =>
      {
