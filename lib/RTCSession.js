          ...
          sdp.media.forEach((media) =>
          {
            if (media.type === 'video')
            {
              ...
              media.rtp.forEach((rtp) => 
              {
                ...
                if (rtp.codec.toLowerCase() === 'h264' && CH264>0)
                {
                  CH264--;
                  payloadArr.push(rtp.payload);
                }
              ...
              media.fmtp && (media.fmtp = media.fmtp.filter((r) => payloadArr.indexOf(r.payload) !== -1));
              media.rtp && (media.rtp = media.rtp.filter((r) => payloadArr.indexOf(r.payload) !== -1));
              media.rtcpFb && (media.rtcpFb = media.rtcpFb.filter((r) => payloadArr.indexOf(r.payload) !== -1));
