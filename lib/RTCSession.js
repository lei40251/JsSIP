...
module.exports = class RTCSession extends EventEmitter
{
  ...
  upgradeToVideo(options = {}, done = () => {})
  {
    ...
    const videoConstraints = options.videoConstraints ? Object.assign((this._inviteMediaConstraints ? this._inviteMediaConstraints.video : {}),
      options.videoConstraints) : (this._inviteMediaConstraints ? this._inviteMediaConstraints.video : { video: true });
    ...
    return Promise.resolve()
      ...
      .then(() =>
      {
        ...
        if (options.recvOnly)
        {
          opts = { rtcOfferConstraints: { iceRestart: true, offerToReceiveAudio: true, offerToReceiveVideo: true } };
        }
