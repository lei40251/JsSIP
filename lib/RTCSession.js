...
module.exports = class RTCSession extends EventEmitter
{
  ...
  */
    ...
    navigator.mediaDevices.getDisplayMedia({
      ...
      .then((stream) =>
      {
        ...
        stream.addEventListener('inactive', () =>
        {
          if (this._displayMediaStream && this._displayMediaStreamLocallyGenerated)
          {
            ...
            else
            {
              this._displayMediaStream = null;
              this._displayMediaStreamLocallyGenerated = false;
              this._connection.removeTrack(this._rtpSender);
              this.renegotiate();
            }
          }
        });
        ...
        else
        {
          stream.getVideoTracks().forEach((track) =>
          {
            this._rtpSender = this._connection.addTrack(track, stream);
            this.renegotiate();
          });
        }
      })
   ...
   */
  _sendInitialRequest(mediaConstraints, rtcOfferConstraints, mediaStream, preferredAudioCodec, preferredVideoCodec)
  {
