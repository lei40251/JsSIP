...
const Mixer = require('./MediaStreamComposer');
...
module.exports = class RTCSession extends EventEmitter 
{
  ...
  {
    const options = Object.assign({}, mixerOptions || {});
  ...
  async _applyMixerOnSdkGumStream(stream, mixerOptions)
  {
    ...
    const mixerCtorOptions = this._buildMixerCtorOptions(stream, mixerOptions);
    let mixer = null;
  ...
  connect(target, options = {}, initCallback) 
  {
    ...
    const mixerOptions = options.mixer || null;
