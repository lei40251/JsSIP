...
module.exports = class RTCSession extends EventEmitter
{
  ...
  upgradeToVideo(options = {}, done = () => {})
  {
    ...
    const videoConstraints = options.videoConstraints ? Object.assign(this._inviteMediaConstraints.video, options.videoConstraints) :
      (this._inviteMediaConstraints ? this._inviteMediaConstraints.video : { video: true });
    ...
    this._connectionPromiseQueue = this._connectionPromiseQueue
      ...
      .then(() =>
      {
        ...
        if (this._remoteToVideo && !this._localToAudio && this._notHold && !hasVideo && (this._customMediaStream === false))
        {
          ...
          const videoConstraints = this._inviteMediaConstraints.video ? { video: this._inviteMediaConstraints.video } : { video: true };
