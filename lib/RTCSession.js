...
module.exports = class RTCSession extends EventEmitter
{
  ...
  constructor(ua)
  {
    ...
    // 分享视频流
    this._videoShareStream = null;
    this._videoStremLocallyGenerated = false;
  ...
  */
  ...
  unVideoShare()
  {
    ...
    this._localMediaStream.getVideoTracks().forEach((track) =>
    {
      ...
      Utils.closeMediaStream(this._videoShareStream);
    });
  }
    ...
    Promise.resolve()
      ...
      .then((stream) =>
      {
        ...
        if (preferredAudioCodec)
        {
          ...
          const transceiver = this._connection.getTransceivers().find((t) =>
          {
