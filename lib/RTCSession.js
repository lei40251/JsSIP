...
module.exports = class RTCSession extends EventEmitter
{
  ...
  _initDataChannel(event)
  {
    ...
    datachannel.onopen = () =>
    {
      ...
      datachannel.bufferedAmountLowThreshold = this.lowWaterMark;
  ...
  _sendData(datachannel)
  {
    ...
    while (this.sendProgressvalue < this.sendProgressmax)
    {
      ...
      if (bufferedAmount >= this.highWaterMark)
      {
        ...
        console.warn(`Paused sending, buffered amount: ${bufferedAmount} (announced: ${datachannel.bufferedAmount})`);
        break;
      }
    }
