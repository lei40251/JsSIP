...
module.exports = class RTCSession extends EventEmitter 
{
  ...
  connect(target, options = {}, initCallback) 
  {
    ...
    const aiVBOptions = this._mediaPipeline.resolveAiVirtualBackgroundOptions(options);
  ...
  upgradeToVideo(options, done) 
  {
    ...
    if (
      Object.prototype.hasOwnProperty.call(options, 'aiVirtualBackground') ||
      Object.prototype.hasOwnProperty.call(options, 'aiVB')
    )
    {
