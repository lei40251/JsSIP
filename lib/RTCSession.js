...
module.exports = class RTCSession extends EventEmitter
{
  ...
  answer(options = {})
  {
    ...
    Promise.resolve()
      ...
      .then(() =>
      {
        ...
        const e = { originator: 'remote', type: 'offer', sdp: request.body, display_mode: this._displayMode };
  ...
  _receiveReinvite(request)
  {
    ...
    if (reqHasVideo && !senderHasVideo)
    {
      ...
      {
        this.emit('openmodal', (rejectVideo) => {
    ...
    function sendAnswer(desc)
    {
      ...
      // Determine incoming media from incoming SDP offer (if any).
      const sdp_m = sdp_transform.parse(desc);
      ...
      const e = { originator: 'local', sdp: desc, display_mode: this._displayMode };
  ...
  _sendReinvite(options = {})
  {
    ...
    this._connectionPromiseQueue = this._connectionPromiseQueue
      ...
      .then((sdp) =>
      {
        ...
        const e = { originator: 'local', type: 'offer', sdp, display_mode: this._displayMode };
    ...
    function onSucceeded(response)
    {
      ...
      const e = { originator: 'remote', type: 'answer', sdp: response.body, display_mode: this._displayMode };
