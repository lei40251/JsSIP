    ...
    this._statsTimer = setInterval(async() =>
    {
      ...
      try
      {
        this._pc.getSenders().forEach((s) =>
        {
          ...
          logger.debug(`settings: ${JSON.stringify(s.track.getSettings())} ***** constraints: ${JSON.stringify(s.track.getConstraints())} ***** capabilities: ${JSON.stringify(s.track.getCapabilities())}`);
        });
      }
      catch (error)
      {
