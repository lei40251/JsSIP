...
module.exports = class getStats extends EventEmitter
{
  ...
  start()
  {
    this._statsTimer = setInterval(async() =>
    {
      ...
      {
        const trackStatus = `id: ${s.track.id}, enabled: ${s.track.enabled}, label: ${s.track.label},kind: ${s.track.kind},muted: ${s.track.muted},readyState: ${s.track.readyState},transport: ${s.transport.state};`;
