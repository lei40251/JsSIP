    ...
    stats.forEach((report) =>
    {
      switch (report.type)
      {
        case 'remote-inbound-rtp':
          ...
          {
            this._stats.video.uplinkRTT = report['roundTripTime'];
          ...
          {
            this._stats.audio.uplinkRTT = report['roundTripTime'];
        ...
        case 'remote-outbound-rtp':
          if (report.kind === 'video')
          {
            this._stats.video.downlinkRTT = report['roundTripTime'];
          }
          else if (report.kind === 'audio')
          {
            this._stats.audio.downlinkRTT = report['roundTripTime'];
          }
          break;
        case 'outbound-rtp':
          if (report.kind === 'video')
