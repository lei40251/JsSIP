...
const POST_PROCESSING_OPTION_KEYS = [ 'blurRadius', 'maxBlurRadius' ];

/** `assetConfig` 选项块下已识别的 key */
const ASSET_CONFIG_OPTION_KEYS = [ 'cdnUrl', 'baseUrl', 'flatBaseUrl', 'moduleUrl', 'wasmBaseUrl', 'modelUrl' ];
...
exports.normalizeAssetConfig = function(assetConfig)
{
  ...
  {
    const baseUrl = assetConfig.flatBaseUrl.trim().replace(/\/$/, '');
