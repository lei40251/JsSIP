...
class CommonHeader
{
  ...
  {
    const ver = '001';
    const reserved = '00000';
    const primitive = Complements.complementBinary(this.primitive.toString(2), 8);
    const payloadLength = Complements.complementBinary(this.payloadLength.toString(2), 16);
    const conferenceId = Complements.complementBinary(this.conferenceId.toString(2), 32);
    const transactionId = Complements.complementBinary(this.transactionId.toString(2), 16);
    const userId = Complements.complementBinary(this.userId.toString(2), 16);
