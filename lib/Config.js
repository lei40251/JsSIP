...
const checks = {
  ...
  optional : {
    ...
    {
      if (Utils.isDecimal(ice_gathering_timeout))
      {
        const value = Number(ice_gathering_timeout);
    ...
    candidates_transport_protocol(candidates_transport_protocol)
    {
      return String(candidates_transport_protocol);
    }
  }
};
