...
class OutputStreamManager
{
  ...
  async _writePresentedFrame(frameCtx)
  {
    ...
    const videoFrame = await this._createVideoFrameFromCanvas(frameCtx.canvas, frameCtx.timestamp);
  ...
  async _createVideoFrameFromCanvas(canvas, timestamp)
  {
    ...
    return new VideoFrameConstructor(canvas, { timestamp: timestampUs });
  }
