...
module.exports = {
  ...
  *  <li> 该接口不支持在 http 协议下使用，请使用 https 协议部署您的网站。
  * <a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia#Privacy_and_security"> Privacy and security </a>
  *  <li> '出于安全的考虑，在用户未授权摄像头或麦克风访问权限前，label 及 deviceId 字段可能都是空的。
  * 因此建议在用户授权访问后， 再调用该接口获取设备详情，比如在<a href="./LocalStream.html#initialize"> initialize() </a>后再调用此接口获取设备详情。
  * </ul>
