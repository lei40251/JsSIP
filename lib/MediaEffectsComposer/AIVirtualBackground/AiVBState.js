...
module.exports = class AiVBState
{
  ...
  _scheduleSegmentation(state, videoElement, now = this._now())
  {
    ...
    if (state.pendingSegmentation)
    {
      ...
      const segmentationInput = this._getSegmentationInput(state, queuedSource, 'queued');
    ...
    const segmentationInput = this._getSegmentationInput(state, activeSource);
   ...
   */
  _getSegmentationInput(state, frameSource, target = 'active')
  {
