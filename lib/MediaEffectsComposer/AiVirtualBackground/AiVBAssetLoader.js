...
const TASKS_BY_URL_GLOBAL = 'CRTCAiVBVisionTasksByUrl';
...
module.exports = class AiVBAssetLoader
{
  ...
  async ensureTasksLoaded()
  {
    ...
    const tasksByUrl = window[TASKS_BY_URL_GLOBAL] || (window[TASKS_BY_URL_GLOBAL] = {});
  ...
  {
    const scripts = document.querySelectorAll ? document.querySelectorAll('script[data-aivb-module]') : [];
