...
const debugnict = require('debug')('FlyInn:NonInviteClientTransaction');
const debugict = require('debug')('FlyInn:InviteClientTransaction');
const debugact = require('debug')('FlyInn:AckClientTransaction');
const debugnist = require('debug')('FlyInn:NonInviteServerTransaction');
const debugist = require('debug')('FlyInn:InviteServerTransaction');
...
class NonInviteClientTransaction extends EventEmitter
{
  ...
  onTransportError()
  {
    ...
    log.debug(`transport error occurred, deleting transaction ${this.id}`);
    clearTimeout(this.F);
    clearTimeout(this.K);
  ...
  timer_F()
  {
    ...
    log.debug(`Timer F expired for transaction ${this.id}`);
    this.stateChanged(C.STATUS_TERMINATED);
    this.ua.destroyTransaction(this);
...
class InviteClientTransaction extends EventEmitter
{
  ...
  timer_M()
  {
    ...
    log.debug(`Timer M expired for transaction ${this.id}`);
  ...
  timer_B()
  {
    ...
    log.debug(`Timer B expired for transaction ${this.id}`);
  ...
  timer_D()
  {
    ...
    log.debug(`Timer D expired for transaction ${this.id}`);
    clearTimeout(this.B);
    this.stateChanged(C.STATUS_TERMINATED);
    this.ua.destroyTransaction(this);
  }
...
class AckClientTransaction extends EventEmitter
{
  ...
  onTransportError()
  {
    ...
    log.debug(`transport error occurred for transaction ${this.id}`);
    this.eventHandlers.onTransportError();
  }
}
...
class NonInviteServerTransaction extends EventEmitter
{
  ...
  timer_J()
  {
    ...
    log.debug(`Timer J expired for transaction ${this.id}`);
    this.stateChanged(C.STATUS_TERMINATED);
    this.ua.destroyTransaction(this);
  }
...
class InviteServerTransaction extends EventEmitter
{
  ...
  timer_H()
  {
    ...
    log.debug(`Timer H expired for transaction ${this.id}`);

    if (this.state === C.STATUS_COMPLETED)
    {
      debugist('ACK not received, dialog will be terminated');
      log.debug('ACK not received, dialog will be terminated');
    }
  ...
  timer_L()
  {
    ...
    log.debug(`Timer L expired for transaction ${this.id}`);
