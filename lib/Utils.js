          ...
          if (sender.track && sender.track.readyState === 'live')
          {
            ...
            else
            {
              ...
              const isCanvasTrack = () =>
              {
                ...
                return settings.deviceId === 'canvas' ||
                  sender.track.label.toLowerCase().includes('canvas') ||
                  (sender.track.constructor && sender.track.constructor.name === 'CanvasCaptureMediaStreamTrack') ||
                  (sender.track.kind === 'video' && sender.track.contentHint === 'drawing');
              };
