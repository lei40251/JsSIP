module.exports = {
  ...
  BFCP_TRANSCEIVER_INDEX   : 'transceiver_index',
  ...
  // 连接与协商超时 (ms)
  CONNECTION_TIMEOUT          : 5000, // UA 连接超时
  ICE_CANDIDATE_FORCE_TIMEOUT : 2000, // ICE 候选收集强制结束超时
  ICE_GATHERING_WAIT_TIMEOUT  : 500, // ICE gathering 状态等待超时
  DISCONNECT_RECONNECT_DELAY  : 5000, // ICE 断开后重连延迟
  CLOSE_TIMER_DELAY           : 2000, // UA 关闭等待延迟
 
  // 视频与分享参数
  VIDEO_KEYFRAME_INTERVAL  : 0.5, // 关键帧发送间隔 (秒)
  SHARE_CAPTURE_FPS        : 15, // 分享流默认帧率
  SHARE_CAPTURE_MAX_WIDTH  : 1920, // 分享流最大宽度
  SHARE_CAPTURE_MAX_HEIGHT : 1080, // 分享流最大高度
  MUTED_CANVAS_FPS         : 1, // 静音占位视频帧率
  MUTED_CANVAS_WIDTH       : 640, // 静音占位视频宽度
  MUTED_CANVAS_HEIGHT      : 480, // 静音占位视频高度

  // 设备兼容延迟 (ms)
  IOS_SWITCH_DEVICE_DELAY       : 500, // iOS 切换设备重试延迟
  WECHAT_AUDIO_RENDER_DELAY     : 100, // 微信安卓音频渲染延迟
  BFCP_DC_RECONNECT_CHECK_DELAY : 1000 // BFCP DataChannel 断线检查延迟
};
