...
module.exports = class Dialog
{
  ...
  sendRequest(method, options = {})
  {
    ...
    const RSeq = options.RSeq || null;
    const body = options.body || null;
    const request = this._createRequest(method, extraHeaders, body, { RSeq: RSeq });
  ...
  // RFC 3261 12.2.1.1.
  _createRequest(method, extraHeaders, body, options={})
  {
    ...
    // 增加100rel的 prack
    options.RSeq && extraHeaders.push(`RAck: ${options.RSeq} ${ this._invite_seqnum } INVITE`);
