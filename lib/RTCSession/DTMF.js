...
const debug = require('debug')('FlyInn:RTCSession:DTMF');
const debugerror = require('debug')('FlyInn:ERROR:RTCSession:DTMF');
...
module.exports = class DTMF extends EventEmitter
{
  ...
  init_incoming(request)
  {
    ...
    if (!this._tone)
    {
      ...
      log.debug('invalid INFO DTMF received, discarded');
    }
    else
    {
      this._session.newDTMF({
