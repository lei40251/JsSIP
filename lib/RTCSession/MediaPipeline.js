...
module.exports = class MediaPipeline
{
  ...
  getAiVirtualBackground()
  {
    ...
    const composer = session._mediaStreamComposer;
    ...
    const sources = normalizeComposerSourceList(session._sessionMediaStreamComposerOptions);
  ...
  resolveMediaStreamComposerOptions(options = {})
  {
    ...
    {
      const composerOptions = options.mediaStreamComposer || null;
