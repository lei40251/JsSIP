...
(function() {
  ...
  class DeepFilterAudioProcessor extends AudioWorkletProcessor
  {
    constructor(options)
    {
      ...
      this.reportedBadChannels = false;
    ...
    passInput(inputChannels, outputList, sourceLimit)
    {
    ...
    reportBadChannels(inputChannels, outputList)
    {
      if (this.reportedBadChannels)
      {
        return;
      }

      this.reportedBadChannels = true;
    ...
    process(inputList, outputList)
    {
      ...
      {
        this.reportBadChannels(inputChannels, outputList);
        this.passInput(inputChannels, outputList, sourceLimit);
      ...
      catch (error)
      {
        ...
        if (!this.reportedFailure && this.port && typeof this.port.postMessage === 'function')
        {
