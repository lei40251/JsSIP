...
{
  PostMsgToEts({ status: 'registered', data: data });
  PostMsgToEts(JSON.stringify({ status: 'registered1', data: data }));
...
function PostMsgToEts(data)
{
  ...
  {
    setStatus('h5Port is null, Please initialize first');
